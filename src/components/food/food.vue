    ...
    <div class="food" v-show="showFlag" ref="foodContent">
      <div class="food-content">
        <div class="image-header">
          <img :src="food.image" alt="header_image">
          ...
          <ul v-show="food.ratings && food.ratings.length">
            <li v-show="needShow(rating.rateType,rating.text)" v-for="rating in food.ratings" class="rating-item border-1px">
              <div class="user">
                ...
                <img width="12" height="12" :src="rating.avatar" alt="user_avatar" class="avatar">
              </div>
...
<script>
  ...
  export default {
    ...
    created() {
      this.$root.eventHub.$on('changeType',this.changeType);
      this.$root.eventHub.$on('toggleContent',this.changeContent);
    },
    beforeDestroy() {
      this.$root.eventHub.$off('changeType',this.changeType);
      this.$root.eventHub.$off('toggleContent',this.changeContent);
    },
    data() {
      return {
        showFlag: false,
